...
for sheet_name in wb.sheetnames:
    ...
    for idx, img in enumerate(images):
        ...
        # Try to save image
        image_data = img.ref # img.ref is the image object in openpyxl, or img.image is PIL Image
        # Actually img.image is PIL Image object if it's loaded, or we can use img._data() or img.image
        try:
            pil_img = img.image
